    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link btn btn-light text-dark ms-3" href="home.jsp">Login</a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-striped table-hover align-middle">
                    ...
                    <tbody>
                        <c:forEach var="cus" items="${service}">
                            <tr>
                                <td>${cus.name}</td>
                                <td>${cus.email}</td>
                                <td>${cus.service}</td>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <form action="singalorderservlet" method="post" class="me-2">
