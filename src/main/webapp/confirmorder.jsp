...
<head>
    ...
    <script>
        ...
        function validateForm() {
            ...
            // Name validation: Must be at least 3 characters long and only letters/spaces
            const nameRegex = /^[a-zA-Z\s]{3,}$/;
            if (!nameRegex.test(name)) {
                alert("Name must be at least 3 characters long and only contain letters and spaces.");
                return false;
            }
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link btn btn-light text-dark ms-3" href="NewLogIn.jsp">Login</a>
                </li>
            </ul>
        </div>
    </div>
...
<div class="container d-flex justify-content-center align-items-center vh-100">
    <div class="card shadow-lg p-4" style="width: 100%; max-width: 400px;">
        ...
        <div class="card-body">
            <form action="confirmorderservlet" method="post" onsubmit="return validateForm()">
                <div class="mb-3">
