...
<header>
    <div class="container">
        ...
        <p>Review and update the complaint information.</p>
    </div>
</header>
...
<div class="container d-flex justify-content-center align-items-center vh-100">
    <div class="card shadow-lg" style="width: 100%; max-width: 600px;">
        ...
        <div class="card-body">
            <c:set var="com" value="${complaint}" />
            <!-- Complaint details form -->
            <form method="post" action="comupdate.jsp">
                <div class="form-group mb-3">
                    <label for="name" class="form-label">Name</label>
                    <input type="text" class="form-control" id="name" name="name" value="${com.name}" readonly>
                </div>

                <div class="form-group mb-3">
                    <label for="email" class="form-label">Email address</label>
                    <input type="email" class="form-control" id="email" name="email" value="${com.email}" readonly>
                </div>

                <div class="form-group mb-3">
                    <label for="complaint" class="form-label">Complaint</label>
                    <input type="text" class="form-control" id="complaint" name="complaint" value="${com.complaint}" readonly>
                </div>

                <!-- Hidden inputs for updating -->
                <input type="hidden" name="name" value="${com.name}">
                <input type="hidden" name="email" value="${com.email}">
                <input type="hidden" name="complaint" value="${com.complaint}">

                <button type="submit" class="btn btn-primary w-100 mb-3">Update</button>
            </form>

            <!-- Back to Complaint Form Button -->
            <a href="complaint.jsp" class="btn btn-secondary w-100">Back to Complaint Form</a>
        </div>
    </div>
</div>
